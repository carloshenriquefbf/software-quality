...
* **ID do Caso de Teste**: TC_RF01
    ...
    * **Descrição**: Verificar se o dispositivo Dashboard obtém corretamente os limites de temperatura, CO2 e ocupação do broker no momento da inicialização.
    * **Pré-condições**: Broker ativo com os parâmetros publicados.
    * **Passos de Teste**:
        1. Ligar o dispositivo Dashboard.
    ...
    * **Resultado Esperado**: O dispositivo Dashboard deve obter corretamente os limites de temperatura, CO2 e ocupação do broker no momento da inicialização.
