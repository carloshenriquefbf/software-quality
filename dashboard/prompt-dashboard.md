...
Link da conversa: https://chat.deepseek.com/share/y4nipchakvg758pjy2
...
Você recebeu a demanda de construir o plano de teste a partir do contexto fornecido abaixo, pelo documento "geral.md" que descreve o software, do documento "requisitos-dashboard.md" que descreve os requisitos do subsistema dashboard e do documento "plano-de-testes-dashboard.md", que descreve os planos de teste e dá o exemplo de um caso de teste detalhado usando um dos requisitos.
